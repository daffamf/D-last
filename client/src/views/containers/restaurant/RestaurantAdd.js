...
import { addRestaurant, editRestaurant } from '../../../redux/actions';
...
class RestaurantAdd extends Component {
    ...
    btnAdd = (event) => {
        if (this.state.alamat && this.state.nama && this.state.email && this.state.phone && this.state.coordinate) {
            this.props.addRestaurant(this.state.kategori, this.state.alamat, this.state.nama, this.state.email, this.state.phone, this.state.coordinate, this.state.file)
        }
        event.preventDefault();
    }

    btnUpdate = (event) => {
        this.props.editRestaurant(this.state.id, this.state.kategori, this.state.alamat, this.state.nama, this.state.email, this.state.phone, this.state.coordinate)
        event.preventDefault();
    }
                        ...
                        <div className="col-9">
                            <div className="invoice-details-header bg-white d-flex align-items-sm-center flex-column flex-sm-row mb-30 justify-content-sm-between">
                                <div className="d-flex align-items-center">
                                    ...
                                    <h2 className="regular mr-3 font-30">{this.props.id ? 'Edit' : 'Add'}</h2>
                                </div>
                            </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-4">
                                            <div className="invoice-right mt-5 mt-md-0">
                                                <h3 className="white font-20 mb-3">Merchant</h3>
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6 col-md-6">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="theme-input-style" placeholder="Masukkan nama usaha" name="nama" onChange={this.handleInputChange} value={this.state.nama} required />
                                            </div>
                                            <div className="form-group">
                                        ...
                                        <div className="col-lg-6 col-md-6">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="theme-input-style" placeholder="08xxxx" name="phone" onChange={this.handleInputChange} value={this.state.phone} required />
                                            </div>
                                            <div className="form-group">
                                                <label className="font-14 bold mb-2">Alamat</label>
                                                <input type="text" className="theme-input-style" placeholder="Masukkan alamat" name="alamat" onChange={this.handleInputChange} value={this.state.alamat} required />
                                            </div>
                                            <div className="form-group">
                                                <label className="font-14 bold mb-2">Coordinate</label>
                                                <input type="text" className="theme-input-style" placeholder="Masukkan coordinate" name="coordinate" onChange={this.handleInputChange} value={this.state.coordinate} required />
                                            </div>
                                        </div>
                                    ...
                                    <div className="cart-collaterals style--two pt-4 pt-xl-0">
                                        <div className="cart_totals calculated_shipping">
                                            <div className="proceed-to-checkout invoice-edit d-flex align-items-center justify-content-end mr-20 mt-4">
                                                <a href="/admin/restaurant" className="btn btn-primary">Cancel</a>
...
const mapDispatchToProps = dispatch => ({
    addRestaurant: (kategori, alamat, nama, email, phone, coordinate, file) => dispatch(addRestaurant(kategori, alamat, nama, email, phone, coordinate, file)),
    editRestaurant: (id, kategori, alamat, nama, email, phone, coordinate) => dispatch(editRestaurant(id, kategori, alamat, nama, email, phone, coordinate))
})
