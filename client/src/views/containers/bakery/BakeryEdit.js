...
class BakeryEdit extends Component {
    constructor(props) {
        super(props)
        this.state = {
            alamat: '',
                        ...
                        <div className="col-9">
                            <div className="invoice-details-header bg-white d-flex align-items-sm-center flex-column flex-sm-row mb-30 justify-content-sm-between">
                                <div className="d-flex align-items-center">
                                    ...
                                    <h2 className="regular mr-3 font-30">Add</h2>
                                    <h4 className="c4">#256987</h4>
                                </div>
                                <div className="invoice-header-right d-flex align-items-center justify-content-around justify-content-sm-end mt-3 mt-sm-0">
                                    <div className="star mr-20">
                                        <a href="#"><img src={star} alt="" className="svg" /></a>
                                    </div>
                                    <div className="delete_mail">
                                        <a href="#"><img src={delete_icon} alt="" className="svg" /></a>
                                    </div>
                                    <div className="pagination style--two d-flex flex-column align-items-center ml-2">
                                        <ul className="list-inline d-inline-flex align-items-center">
                                            <li><a href="#">
                                                <img src={left_angle} alt="" className="svg" />
                                            </a></li>
                                            <li><a href="#" className="current">
                                                <img src={right_angle} alt="" className="svg" />
                                            </a></li>
                                        </ul>
                                    </div>
                                </div>
