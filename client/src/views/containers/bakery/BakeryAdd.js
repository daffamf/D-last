...
import { addBakery, editBakery } from '../../../redux/actions';
...
class BakeryAdd extends Component {
    constructor(props) {
        super(props)
        this.state = {
            id: this.props.id || '',
    ...
    btnUpdate = (event) => {
        this.props.editBakery(this.state.id, this.state.kategori, this.state.alamat, this.state.nama, this.state.email, this.state.phone, this.state.coordinate)
        event.preventDefault();
    }
                        ...
                        <div className="col-9">
                            <div className="invoice-details-header bg-white d-flex align-items-sm-center flex-column flex-sm-row mb-30 justify-content-sm-between">
                                <div className="d-flex align-items-center">
                                    <a href="/admin/bakery" className="mr-2"><img src={angle_left} alt="" className="svg" /></a>
                                    ...
                                    <div className="cart-collaterals style--two pt-4 pt-xl-0">
                                        <div className="cart_totals calculated_shipping">
                                            <div className="proceed-to-checkout invoice-edit d-flex align-items-center justify-content-end mr-20 mt-4">
                                                <a href="/admin/bakery" className="btn btn-primary">Cancel</a>
...
const mapDispatchToProps = dispatch => ({
    ...
    editBakery: (id, kategori, alamat, nama, email, phone, coordinate) => dispatch(editBakery(id, kategori, alamat, nama, email, phone, coordinate))
})
